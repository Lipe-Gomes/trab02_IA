...
textbf{UNIVERSIDADE DE SÃO PAULO}\\
\textbf{INSTITUTO DE CIÊNCIAS MATEMÁTICAS E DE COMPUTAÇÃO}\\
\textbf{DEPARTAMENTO DE CIÊNCIAS DE COMPUTAÇÃO}\\
\vspace{1.5cm}
\textbf{SCC0630 - Inteligência Artificial\\Profa. Dra. Solange Oliveira Rezende}\\
\vspace{3.5cm}
{\fontsize{18pt}{22.5pt}\selectfont \textbf{Trabalho 02 - Relatório de conversa com LLM sobre o escopo do projeto}}\\
...
\begin{tabular}{@{}l l@{}}
\textbf{Alexandre} & \textbf{} \\
\textbf{Felipe de Oliveira Gomes} & \textbf{1461} \\
\textbf{Gabriel dos Santos Alves} & \textbf{} \\
\textbf{Leonardo Codeceira Gonçalves Pinto} & \textbf{14588200} \\
\textbf{Leonardo Silva Cardoso} & \textbf{14588509} \\
\textbf{Thiago de Castro Valverde} & \textbf{14609241} \\
\end{tabular}
\vfill
\begin{center}
{São Carlos\\2026}  
